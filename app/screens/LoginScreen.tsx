...
import {View, Text, TextInput, Button, Alert, Keyboard, Vibration, Platform} from 'react-native';
...
export default function LoginScreen({navigation} : any) {
    ...
    return (
        <View style={[styles.container, {backgroundColor: "#000"}]}>
            ...
            <TextInput
                style={[styles.input, {borderColor: "#666", color: "#fff"}]}
                placeholder="Email"
                value={email}
            ...
            />
            <Modal isVisible={showPrompt} style={{backgroundColor: "#111"}}>
