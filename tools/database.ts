...
const Database = {
    init: async () => {
        console.log('Database initializing (API mode with JWT)');
    },

    register: async ({ email, password, realName, group, displayedName }: RegisterType) => {
    ...
    getUsername: async (setUsername: any) => {
    ...
    changeImage: async (payload: JSON) => {
        const response = await fetch(`${API_URL}/current-user`, {
            method: 'POST',
            headers: await authHeaders(),
    ...
    getFollowingPosts: async (page: bigint) => {
    ...
    getAllComments: async (page: bigint) => {
    ...
    getPostComments: async (postId: bigint) => {
    ...
    getPostCommentsCount: async (postId: bigint) => {
    ...
    addComment: async ({ postId, content } : {postId:bigint, content:string}) => {
    ...
    getLikePost: async (postId: bigint) => {
    ...
    unlikePost: async (postId: bigint) => {
    ...
    getCommentLikes: async (commentId: bigint) => {
    ...
    likeComment: async (commentId: bigint) => {
    ...
    unlikeComment: async (commentId: bigint) => {
    ...
    followTag: async (tagName: bigint) => {
    ...
    unfollowTag: async (tagName: bigint) => {
    ...
    addCommentBase64: async ({ postId, content, isAnonymous, imageBase64 }: any) => {
...
Database.init().then(() => console.log("Database initialized (API mode with JWT)"));
